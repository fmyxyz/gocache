...
func (m *MockStoreInterface) Invalidate(options ...store.InvalidateOption) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{}
...
func (m *MockStoreInterface) Set(key, value interface{}, options ...store.Option) error {
	m.ctrl.T.Helper()
...
func (mr *MockStoreInterfaceMockRecorder) Set(key, value interface{}, options ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
